...
export const WHEEL_GAMES: MinigameMeta[] = [
  ...
  { id: 'reaction', label: 'Reaction', emoji: '⚡', color: '#facc15', playable: true, blurb: 'Wait for green, then tap — fastest finger wins', tag: 'Fastest finger' },
]

// Games used as Truth-or-Dare round openers — only those with a clear single
// loser (no turn-based games like Connect 4).
export const TOD_MINIGAMES: MinigameId[] = ['frogger', 'snake', 'flappy', 'memory', 'reaction']
