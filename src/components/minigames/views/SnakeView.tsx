...
import { makeSnakeScene, SNAKE_W, SNAKE_H } from './phaser/snakeScene'
import { useGameBridge, RaceLeaderboard, RoundStatusBar, Dpad } from './shared'

export function SnakeView(props: GameViewProps) {
  ...
  return (
    <div className="race-layout">
      <div className="race-main">
        ...
        <p className="race-hint">Swipe or use arrows. Eat the red dots — don&apos;t hit yourself.</p>
      </div>
